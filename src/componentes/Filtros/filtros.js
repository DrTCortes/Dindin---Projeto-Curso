...
export default function Filtros({ transactionsData, setTransactionsData }) {
  const diasDaSemana = [
    {
      nome: "Domingo",
      selecionado: false,
  ...
  const [transactionsDataAfterFilter, setTransactionsDataAfterFilter] =
  ...
  const selecionarFiltroCategoria = (nome) => {
    ...
    const categoriasSelecionadas = listaDascategorias.find(
  ...
  function filtrarCategorias() {
    const categoriasSelecionadas = categorias.filter(
      (categoria) => categoria.selecionado
    );
  ...
  function filtrarValor() {
    ...
    const arrayDoEstadoFiltrado = arrayDoEstado.filter((x) => {
      ...
      return valor >= valorMinimo * 100 && valor <= valorMaximo * 100
        ? true
        : false;
    });
    return arrayDoEstadoFiltrado;
  ...
  function aplicarFiltros() {
    ...
    const todosOsFiltros = diasFiltrados.concat(
      categoriasFiltradas,
      valoresFiltrados
    );
    ...
    <div className="container-filters">
            ...
            return (
              ...
              >
                ...
                <img
                  ...
                  src={dia.selecionado ? exclui : acrescenta}
                  alt="botão"
                />
              </button>
            );
          ...
          {categorias.map((categoria) => {
            return (
              ...
              >
                ...
                <img
                  className="icon-filter"
                  src={categoria.selecionado ? exclui : acrescenta}
                  alt="botão"
                />
              </button>
            );
      ...
      <div className="value">
        ...
        <div className="values">
          <label className="values-label" htmlFor="min-value">
            Min
          </label>
          <br />
          <input
        ...
        <div className="values">
          <label className="values-label" htmlFor="max-value">
            Max
          </label>
          <br />
          <input
      ...
      <div className="btn-filters">
        ...
        <button className="btn-aplly-filters" onClick={() => aplicarFiltros()}>
          Aplicar Filtros
        </button>
      </div>
    </div>
